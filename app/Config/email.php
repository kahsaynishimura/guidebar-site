...
class EmailConfig {
    ...
    public $smtp = array(
        ...
        'from' => array('thiago@guidebar.com.br' => 'Guidebar'), //an array containing the "from" address and sender name
        'host' => 'mail.guidebar.com.br', //add your SMTP mail server here
//        'timeout' => 30,
        ...
        'username' => 'thiago@guidebar.com.br',
        'password' => '$0rvete$0rte',
        'client' => null,
