<table>
    <tbody>
        ...
        foreach ($tickets as $ticket):
            ...
            ?>
        <td>
            <div><img src="<?php echo 'https://chart.googleapis.com/chart?cht=qr&chs=150x150&choe=UTF-8&chl=http://guidebar.com.br/purchases/processCode/' . $ticket['Purchase']['code'].'.json'; ?>"/></div> 
