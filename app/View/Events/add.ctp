...
<script>
    ...
    $(document).ready(function() {
        $('#novoEvento').parent().addClass('active');
...
<div class="form">
    ...
    <div class="panel panel-guidebar">
        ...
        <div class="panel-body">
            ...
            <div class="col-md-7"> 
                <div class="col-md-4">
                    <?php echo $this->Html->Image('icone_transparente.png', array('alt' => 'ícone do evento', 'style' => "width:150px;", 'id' => "previewImage", 'class' => 'img-responsive event_profile_image thumbnail')); ?>
            ...
            <div class="panel panel-guidebar">
                ...
                <div class="panel-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <?php
                            $options['selected'] = $dt->format('Y-m-d H:i:s');
                ...
                <div class="panel-body">
                    <div id="div_ticket_form" class="row" style="margin-bottom:10px;">
                        ...
                        <div class="col-md-3">
                            ...
                            <center>
                                <?php
                                echo $this->Form->button(__("Adicionar"), array('type' => 'button',
                                    'class' => 'btn btn-default', 'onclick' => "addTicket()", 'style' => "font-size: 90%;", 'div' => 'form-group'));
                                ?>                                
                            </center>
                        </div>
                    </div>
            ...
            <div class="panel panel-guidebar">
                ...
                <div class="panel-body">
                    ...
                    <div id="divEventAddress" style="margin-bottom:5px;">  
                        <center>
                            <?php echo $this->Form->input('address_id', array('id' => 'userAddresses', 'name' => 'data[Event][address_id]', 'label' => false, 
    ...
    ?>
    <div class="btn-group">
        <?php echo $this->Form->input(__('Salvar'), array('label' => false, 'div' => false, 'alt' => 'Apenas eu posso visualizar este evento', 'type' => 'button', 'onclick' => 'setIsActive(0)', 'class' => 'btn btn-default')); ?>
        <?php echo $this->Form->input(__('Salvar e Publicar'), array('label' => false, 'div' => false, 'alt' => 'Todos podem visualizar este evento', 'type' => 'button', 'onclick' => 'setIsActive(1)', 'class' => 'btn btn-default')); ?>
    </div>
