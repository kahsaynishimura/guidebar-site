...
class CarrinhoComponent extends Component {
    ...
    /**
     * Define uma URL para receber o código da transacao
     * 
     * @param string $urlNotificacao
     * @since 1.0
     */
    public function setUrlNotificacao($urlNotificacao = null) {
        $this->montaPagamento->addParameter('notificationURL', $urlNotificacao);
    }
